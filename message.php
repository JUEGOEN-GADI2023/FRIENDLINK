...
<div class="container">
  <div class="row">
	...
	");
										...
										<div class="control-group">
                                          <div class="controls">
                                              <button  class="btn btn-success"><i class="icon-envelope-alt"></i> Enviar </button><br>
                                              
                                          </div>
                                        </div>
                                          <br>   Chatea en Vivo con:<br>
                                              <button  class="btn btn-success><i class="icon-envelope-alt">   <a href="chat/login.php" target="_blank">Chat Live</a> </button>
